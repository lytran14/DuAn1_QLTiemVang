 ...
 * @author Acer
 */
public class FormSanPhamMuaVao extends javax.swing.JFrame {

    /**
     * Creates new form FormSanPhamMuaVao
     */
    public FormSanPhamMuaVao() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSanPhamMuaVao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSanPhamMuaVao().setVisible(true);
            }
        });
    }
