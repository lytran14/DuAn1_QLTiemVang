 ...
 * @author Acer
 */
public class FormSanPhamBanRa extends javax.swing.JFrame {

    /**
     * Creates new form FormSanPhamBanRa
     */
    public FormSanPhamBanRa() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSanPhamBanRa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSanPhamBanRa().setVisible(true);
            }
        });
    }
